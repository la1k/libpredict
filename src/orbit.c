 ...
 **/
bool predict_is_geostationary(const orbit_t *m)
{
...
bool predict_aos_happens(const orbit_t *m, double latitude)
{
...
int predict_orbit(orbit_t *m, double utc)
{
...
bool predict_decayed(const orbit_t *orbit)
{
...
bool predict_is_eclipsed(const orbit_t *orbit)
{
	return orbit->eclipsed;
}

double predict_eclipse_depth(const orbit_t *orbit)
{
